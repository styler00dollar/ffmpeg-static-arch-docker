...
- [markus-perl/ffmpeg-build-script](https://github.com/markus-perl/ffmpeg-build-script/blob/master/build-ffmpeg)
- [testcab/docker-yay](https://github.com/testcab/docker-yay/blob/master/Dockerfile)
